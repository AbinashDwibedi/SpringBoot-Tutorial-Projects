...
import com.abinash.personnel.hospitalManagement.service.AppointmentService;
import com.abinash.personnel.hospitalManagement.service.InsuranceService;
...
public class InsuranceTests {
    ...
    public void testInsurance(){
        Insurance insurance = Insurance.builder().policyNumber("HDFC_1234").provider("HDFC").validUntil(LocalDate.of(2003,12,12)).build();
    ...
    public  void testCreateAppointment(){
        ...
        Appointment appointment1 = appointmentService.reAssignAppointmentToAnotherDoctor(newAppointment.getId(),3L);
